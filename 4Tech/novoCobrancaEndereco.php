...
$query_enderecos_cobranca = "SELECT cep, logradouro, numero_endereco, complemento, bairro, cidade, uf, cliente_id
...
<body>
    ...
    <header>
            ...
            <?php $row_endereco = $result_enderecos_cobranca->fetch(PDO::FETCH_ASSOC)?>
    </header>
    ...
    <section class="area-edicao">
        ...
        <form id="form-edicao" action="controle_Endereco.php" method="POST">
            <h1>Novo endereco de cobrança</h1>
            <div class="dados-edicao">
                ...
                <div class="form-group row">
                    <div class="col-md-8 offset-md-2">
                        <label>CEP</label>
                        <input type="text" name="cepEntrega" id="txtCep" class="form-control  cep" 
                        placeholder="00000-000" oninput="mascaraCep()" onchange="buscaCep()" required>                        
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <input type="text" name="logradouro" placeholder="logradouro" class="inputs required form-control" id="txtLogradouro">
                        <span class="span-required"></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <input type="bairro" name="bairro" id="txtBairro" placeholder="bairro" class="inputs required form-control">
                        <span class="span-required"></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <input type="cidade" name="cidade" id="txtCidade" placeholder="cidade" class="inputs required form-control">
                        <span class="span-required"></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-8 offset-md-2">
                        <label>UF: </label><br>
                        <select class="form-select form-select-md mb-3 uf" name="ufEntrega" id="slcUf" aria-label=".form-select-lg example" required>
                ...
                <div class="form-group row">
                    <div class=" offset-md-5">
                        <a href="VisualizarEndereco.php?id=<?= $row_endereco['cliente_id'] ?>"><input type="submit" class="btn btn-primary" name="cadastrarEnderecoCobranca" id="btn-edicao" value="Confirmar"></a>
                    </div>
                </div>
                <div class="form-group row">
                    <div class=" offset-md-5">
